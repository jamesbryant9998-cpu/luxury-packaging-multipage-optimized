  ...
  const products = [
    {
      ...
      desc: 'Premium high-end packaging solutions with bespoke finishing, satin ribbons, and multi-color options for elite brands.',
      moq: '500 Pcs',
      leadTime: '10 Days',
      craft: 'Hot Foil Stamping & Ribbon Bow',
      badge: 'New Arrival',
      path: '/products/luxury-gift-boxes-pillar',
      image: '/images/luxury-gift-boxes-pillar-hero.webp'
    },
    {
    ...
    {
      name: 'Custom Magnetic Closure Rigid Boxes',
      desc: 'Premium high-density rigid boxes with high-strength magnetic closure, featuring bespoke geometric textures and elite gold foil branding.',
      moq: '1,000 Pcs',
      leadTime: '12 Days',
      craft: 'Triple-Pass Gold Foil & Geometric Pattern',
      badge: 'Bespoke Masterpiece',
      path: '/products/custom-magnetic-closure-rigid-boxes',
      image: '/images/custom-magnetic-closure-rigid-boxes-elixir.webp'
    },
    {
      name: 'Custom Luxury Paper Gift Bags',
      desc: 'Bespoke high-end paper carrier bags featuring premium ivory cardstock, reinforced handles, and elite gold hot-foil branding for luxury retail.',
      moq: '1,000 Pcs',
      leadTime: '10 Days',
      craft: 'Artisanal Ribbon Handle & Hot Foil',
      badge: 'Premium Carrier',
      path: '/products/luxury-paper-gift-bags',
      image: '/images/luxury-paper-gift-bag-main.webp'
    },
    {
      name: 'Custom Magnetic Rigid Gift Boxes',
      desc: 'Elite navy blue rigid magnetic boxes featuring high-strength hidden magnets, mirror-sharp gold foil crest branding, and custom-molded interior pedestals.',
      moq: '1,000 Pcs',
      leadTime: '12 Days',
      craft: 'Gold Foil Crest & Internal Magnetic Flap',
      badge: 'Luxury Experience',
      path: '/products/custom-magnetic-rigid-gift-boxes-pillar',
      image: '/images/custom-magnetic-rigid-gift-box-blue.webp'
    }
  ];
    ...
    <main style={{ minHeight: '100vh', position: 'relative' }}>
          ...
          <div style={{ maxWidth: '650px', textAlign: 'left' }}>
            ...
            {/* 大标题 */}
              ...
              >
                ...
                <a 
                  href="https://wa.me/8618326001631" 
                  className="btn" 
                  style={{ 
      ...
      <section id="products" className="section">
        <div className="container">
          <div className="section-title-wrapper" style={{ textAlign: isRTL ? 'right' : 'center' }}>
            <h2 className="section-title" style={{ margin: isRTL ? '0 0 10px 0' : '0 auto 10px auto' }}>{t('section_products')}</h2>
        ...
        <div className="container">
          <div className="section-title-wrapper" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px', marginBottom: '40px' }}>
            <div style={{ textAlign: 'left', maxWidth: '600px', margin: 0 }}>
              ...
              <h2 className="section-title" style={{ margin: 0, textAlign: isRTL ? 'right' : 'left', fontSize: '2.5rem' }}>
                {t('section_resources')}
              </h2>
      ...
      {/* 5.1. AEO SMART FAQ (智能问答板块 - 提升 AI 搜索权重) */}
      <section className="section" style={{ backgroundColor: '#070707', borderTop: '1px solid rgba(212, 175, 55, 0.1)' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <span style={{ textTransform: 'uppercase', color: '#d4af37', fontSize: '0.8rem', letterSpacing: '0.2em', fontWeight: 600, display: 'block', marginBottom: '10px' }}>Expert Knowledge</span>
            <h2 style={{ fontSize: '2.5rem', color: '#fff', marginBottom: '15px', textAlign: isRTL ? 'right' : 'center' }}>{t('section_faq')}</h2>
            <p style={{ color: '#a0a0a0', margin: '0 auto' }}>Direct answers to common B2B custom packaging procurement challenges.</p>
          </div>

          <div style={{ display: 'grid', gap: '20px' }}>
            <div style={{ backgroundColor: '#0d0d0d', padding: '30px', borderRadius: '8px', border: '1px solid rgba(212, 175, 55, 0.08)' }}>
              <h4 style={{ color: '#d4af37', fontSize: '1.2rem', marginBottom: '12px', fontWeight: 600 }}>Q1: How do I verify if you are a direct manufacturer in China?</h4>
              <p style={{ color: '#c0c0c0', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>LuxePack Pro holds proprietary ISO 9001:2015 and ISO 14001:2015 certifications in our own legal name. We invite all brand managers for a live video factory tour of our automated V-grooving and lamination lines to verify our 35,000 unit/day capacity directly.</p>
            </div>
            <div style={{ backgroundColor: '#0d0d0d', padding: '30px', borderRadius: '8px', border: '1px solid rgba(212, 175, 55, 0.08)' }}>
              <h4 style={{ color: '#d4af37', fontSize: '1.2rem', marginBottom: '12px', fontWeight: 600 }}>Q2: What are the primary factors affecting the unit price of rigid boxes?</h4>
              <p style={{ color: '#c0c0c0', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>Unit pricing is driven by: (1) Order quantity—reaching 1,000 pcs significantly lowers the per-unit cost; (2) Box architecture—collapsible magnetic boxes save 75% on ocean freight; and (3) Special finishing—Triple-pass gold foil or bespoke linen wrappers carry a premium.</p>
            </div>
            <div style={{ backgroundColor: '#0d0d0d', padding: '30px', borderRadius: '8px', border: '1px solid rgba(212, 175, 55, 0.08)' }}>
              <h4 style={{ color: '#d4af37', fontSize: '1.2rem', marginBottom: '12px', fontWeight: 600 }}>Q3: Do your packaging materials comply with new EU/US environmental laws?</h4>
              <p style={{ color: '#c0c0c0', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>Yes. We provide 100% recyclable, FSC-certified cardboard cores and non-toxic soy inks. Our latest eco-luxury line utilizes sugarcane bagasse molded pulp inserts, allowing global brands to fully bypass single-use plastic bans and Extended Producer Responsibility (EPR) taxes.</p>
            </div>
          </div>
        </div>
      </section>
